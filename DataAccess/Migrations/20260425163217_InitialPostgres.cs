        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsGiftClaimed = table.Column<bool>(type: "boolean", nullable: false, defaultValue: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServicePayments_TransactionCategories_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "TransactionCategories",
                        principalColumn: "TransactionCategoryId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_ServicePayments_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "Users",
                        principalColumn: "UserId",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TransactionCategoryMap", x => new { x.TransactionId, x.TransactionCategoryId });
                    table.ForeignKey(
                        name: "FK_TransactionCategoryMap_TransactionCategories_TransactionCat~",
                        column: x => x.TransactionCategoryId,
                        principalTable: "TransactionCategories",
                        principalColumn: "TransactionCategoryId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TransactionCategoryMap_Transactions_TransactionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServicePayments_CategoryId",
                table: "ServicePayments",
                column: "CategoryId");

            migrationBuilder.CreateIndex(
                name: "IX_ServicePayments_UserId",
                table: "ServicePayments",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_TransactionCategoryMap_TransactionCategoryId",
                table: "TransactionCategoryMap",
